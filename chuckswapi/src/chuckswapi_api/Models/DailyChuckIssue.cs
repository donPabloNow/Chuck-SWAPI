...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DailyChuckIssue : IEquatable<DailyChuckIssue>
    { 
        /// <summary>
        /// Gets or Sets Date
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DailyChuckIssue {\n");
            sb.Append("  Date: ").Append(Date).Append("\n");
            sb.Append("  JokeId: ").Append(JokeId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DailyChuckIssue)obj);
        }

        /// <summary>
        /// Returns true if DailyChuckIssue instances are equal
        /// </summary>
        /// <param name="other">Instance of DailyChuckIssue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DailyChuckIssue other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (JokeId != null)
                    hashCode = hashCode * 59 + JokeId.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DailyChuckIssue left, DailyChuckIssue right)
        {
